...
```
kbb --classpath src:tests -e "(require 'gpu_accelerator.actor-test) (clojure.test/run-tests 'gpu_accelerator.actor-test)"
```

## Provenance

Relocated 2026-07-04 from `etzhayyim/root/20-actors/gpu_accelerator-compat` to
`kotoba-lang/com-gpu-accelerator` per the org-taxonomy library-placement rule (any
